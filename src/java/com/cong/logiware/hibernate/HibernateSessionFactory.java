...
public class HibernateSessionFactory {
    ...
    public static final String PROPERTIES_FILE_LOCATION = "/com/cong/logiware/properties/hibernate.properties";
    ...
    public static void rebuildSessionFactory() {
        try {
            ...
            properties.load(HibernateSessionFactory.class.getResourceAsStream(PROPERTIES_FILE_LOCATION));
